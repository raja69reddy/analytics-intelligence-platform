...
DANGEROUS_KEYWORDS = {
    ...
    "COMMIT", "ROLLBACK", "MERGE", "CALL", "COPY",
}

VALID_TABLES = {
    "raw_ga4_sessions", "raw_server_logs", "raw_scrape_pages", "raw_clickstream_events",
    "dim_pages", "dim_dates", "fct_sessions", "fct_events",
    "vw_traffic", "vw_daily_traffic", "vw_channel_performance",
    "vw_new_vs_returning", "vw_device_breakdown", "vw_geo_performance",
    "vw_top_pages", "vw_page_performance", "vw_error_pages",
    "vw_traffic_by_hour", "vw_user_agents", "vw_scroll_depth",
    "vw_engagement_events", "vw_behavior", "vw_conversions",
    "vw_seo", "vw_funnel",
}
